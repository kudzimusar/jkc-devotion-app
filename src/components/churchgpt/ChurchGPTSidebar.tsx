    ...
    return (
      <aside className="w-16 flex-shrink-0 bg-[#0f1f3d] flex flex-col items-center py-4 transition-all duration-300 border-r border-white/5">
        ...
        <div className="mt-auto pt-4 border-t border-white/5 w-full flex flex-col items-center space-y-4">
          ...
          />
          <div 
            className="w-8 h-8 rounded-full bg-[#1b3a6b] flex items-center justify-center text-[10px] font-bold text-white border border-white/10 uppercase cursor-pointer hover:border-[#D4AF37]/50 transition-all"
    ...
    <aside className="w-[280px] flex-shrink-0 bg-[#0f1f3d] flex flex-col h-full overflow-hidden transition-all duration-300">
      ...
      <div className="p-4 bg-black/20 border-t border-white/5 flex items-center justify-between">
        <div 
          ...
          onClick={() => router.push('/console/profile')}
        >
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1b3a6b] to-[#2a4d8a] flex items-center justify-center text-white text-[10px] font-bold border border-white/20 shrink-0 group-hover:border-[#D4AF37]/50 transition-all">
            {memberProfile?.name?.charAt(0) || "U"}
          </div>
