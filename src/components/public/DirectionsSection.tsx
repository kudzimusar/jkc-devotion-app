          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-4 pt-4">
                ...
                <div>
                  <p className="text-lg font-bold" style={{ color: 'var(--foreground)' }}>〒196-0015 東京都昭島市昭和町2-1-6</p>
                  <p style={{ color: 'var(--muted-foreground)' }}>TE Building, 3rd Floor, Akishima-shi, Tokyo</p>
                </div>
              </div>
            </div>
          </div>
